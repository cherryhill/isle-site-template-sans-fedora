...
function initialize_from_site_template {
  local repo="https://github.com/flummingbird/isle-site-template-sans-fedora"
  local ref
...
function initialize_from_starter_site {
  local repo="https://github.com/flummingbird/codebase_sans_fedora"
  local ref
  echo "Initializing from codebase_sans_fedora..."
  ...
  git add .
  git commit -am "Second commit, added codebase_sans_fedora."
}
